...
function loadAnalyticsModule() {
  const source = analytics
    ...
    .replace(
      /const MIXPANEL_PROJECT_TOKEN =\s*import\.meta\.env\.VITE_MIXPANEL_PROJECT_TOKEN\?\.trim\(\) \|\|\s*'fecdaa3150744c2a60d0f442be77aca6';/,
      "const MIXPANEL_PROJECT_TOKEN = 'fecdaa3150744c2a60d0f442be77aca6';",
    )
